...
namespace UrbanCareBack.Migrations
{
    ...
    [Migration("20241014235903_SeptimaMigracion")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UrbanCareBack.Models.Evento", b =>
                {
                    ...
                    b.Property<int?>("LogEventoIdLogEvento")
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("TipoEventoIdTipoEvento")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("LogEventoIdLogEvento");

                    b.HasIndex("OrganizacionId");

                    b.HasIndex("TipoEventoIdTipoEvento");
            ...
            modelBuilder.Entity("UrbanCareBack.Models.Evento", b =>
                {
                    b.HasOne("UrbanCareBack.Models.LogEvento", null)
                        .WithMany("Eventos")
                        .HasForeignKey("LogEventoIdLogEvento");
                    ...
                    b.HasOne("UrbanCareBack.Models.TipoEvento", null)
                        .WithMany("Eventos")
                        .HasForeignKey("TipoEventoIdTipoEvento");
